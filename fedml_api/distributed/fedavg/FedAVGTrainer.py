...
class FedAVGTrainer(object):
    def __init__(self, client_index, train_data_local_dict, val_data_local_dict, train_data_local_num_dict, train_data_num, device, model,
                 args):
        self.client_index = client_index
        self.train_data_local_dict = train_data_local_dict
        self.val_data_local_dict = val_data_local_dict
        self.val_data_local = val_data_local_dict[client_index]
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            test_acc, test_total, test_loss = self._infer(self.val_data_local)
            wandb.log({"client" + str(self.client_index) + "Val/acc": test_acc/test_total, "client" + str(self.client_index) + "Val/loss": test_loss/test_total})
    ...
    def cyclic_adjust_precision(self, epoch, fixed_sch=False):
